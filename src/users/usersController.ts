import { Body, Controller, Get, Path, Res, Post, Query, Route, Request, Security, SuccessResponse, TsoaResponse } from 'tsoa'
...
export class UsersController extends Controller {
  @Security('session')
  @Get()
  public async getUser(@Request() request: any): Promise<Partial<IUser>> {
